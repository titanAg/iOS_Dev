...
class SalaryEmployee: Employee {
    ...
    override var description: String {
        return String(format: "%@Annual Salary: %@\nPaycheck Amount: %@",super.description, currency(self.annualSalary), currency(self.pay()))
    }
}
...
class HourlyEmployee: Employee{
    ...
    override var description: String {
        return String(format: "%@Hourly Rate: %@\nHours Worked: %.1f\nPaycheck Amount: %@",super.description, currency(self.hourlyRate), self.hoursWorked, currency(self.pay()))
    }
}
...
class Executive: SalaryEmployee {
    ...
    override var description: String {
        return String(format: "%@\nBonus Awarded: %@",super.description, currency(self.bonus))
    }
}
